...
# 确保你有这个权重文件
ckpt_name = 'model_3robots'  # 可选: 'model_3robots_partial', 'model_allegro', 'model_barrett', 'model_shadowhand'
batch_size = 1  # 如果显存不够可以调小
# =================
...
def main():
    ...
    dataloader = create_dataloader(
        SimpleNamespace(**{
            ...
            'robot_names': ['omnihand'], #['barrett', 'allegro', 'shadowhand'], # 这里不包含 omnihand，因为我们测试的是旧模型
